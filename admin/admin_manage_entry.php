            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars(substr($e['skills'], 0, 50)) . (strlen($e['skills']) > 50 ? '...' : ''); ?></td>
                        ...
                        <td class="profile-container">
                            ...
                            ?>
                                <img src="../uploads/profile/<?php echo htmlspecialchars($e['profile_image']); ?>" 
                                     class="thumb" alt="Candidate Profile" title="Candidate: <?php echo $e['name']; ?>">
...
if (!empty($e['document']) && file_exists($docPath)): ?>
    <div class="btn-group btn-group-sm" role="group">
        <?php if ($ext === 'pdf'): ?>
            ...
            <a href="<?php echo $docUrl; ?>" target="_blank" class="btn btn-outline-primary" title="Preview PDF">
                👁️ Preview
            </a>
        <?php endif; ?>
        <!-- Download button -->
        <a href="<?php echo $docUrl; ?>" download class="btn btn-outline-success" title="Download Document">
            ⬇️ Download
        </a>
    </div>
<?php else: ?>
